...
/*
 * Template Name: Child Support Division Record Of Support
 * Version: 1.0.0
...
<htmlpagefooter name="MyCustomFooter">
  <table class="footer">
    <tr class="paragraph">
      <td class="footer_left_half"><span class="bs_bold bs_text_small">CHILD SUPPORT DIVISION - RECORD OF SUPPORT</span></td>
...
$form_id = '49'; $entry = GFAPI::get_entry( $dependentArrayLast);
$form_id = '49'; $entry2 = GFAPI::get_entry( $dependentArrayID2);
$form_id = '49'; $entry3 = GFAPI::get_entry( $dependentArrayID3);
$form_id = '49'; $entry4 = GFAPI::get_entry( $dependentArrayID4);
$form_id = '49'; $entry5 = GFAPI::get_entry( $dependentArrayID5);
$form_id = '49'; $entry6 = GFAPI::get_entry( $dependentArrayID6);
$form_id = '49'; $entry7 = GFAPI::get_entry( $dependentArrayID7);
$form_id = '49'; $entry8 = GFAPI::get_entry( $dependentArrayID8);
$form_id = '49'; $entry9 = GFAPI::get_entry( $dependentArrayID9);
$form_id = '49'; $entry10= GFAPI::get_entry( $dependentArrayID10);
...
<div class = "paragraphborder">This form is used by counties to provide the record of support data needed by the state case registry as required
...
echo "Payment Location: &emsp; &#9744; SDU &emsp; &#9744; County &emsp; &#9746; Other";
 ...
 <div class = "paragraphborderfill text_align_center"> Obligee/Custodial Parent Information
    ...
    <div class = "paragraphborder">
    <div class = "paragraphborder">&#9744;Family Violence Protection (FV) (Check if individual below is a victim of family violence)
        </div>
...
<div class = "paragraphborder"> Address: <?php echo  $obligeeAdressArray['street'] . " " . $obligeeAdressArray['street2'] 
...
<div class = "paragraphrightborder" style = "width: 202px;">Relationship to Child(ren): <?php echo $obligeeRelationshipToChildren ?>
    </div>

<div class = "paragraphborder"> Employer Name: <?php echo $employerName?>
    </div>
    
<div class = "paragraphborder"> Address: <?php echo  $employerAdressArray['street'] . " " . $employerAdressArray['street2'] 
...
<div class = "paragraphborder"> Address: <?php echo  $obligorAdressArray['street'] . " " . $obligorAdressArray['street2'] 
...
<div class = "paragraphrightborder" style = "width: 202px;">Relationship to Child(ren): <?php echo $obligorRelationshipToChildren ?>
    </div>

<div class = "paragraphborder"> Employer Name: <?php echo $employerName?>
    </div>
    
<div class = "paragraphborder"> Address: <?php echo  $employerOAddressArray['street'] . " " . $employerOAddressArray['street2'] 
